...
interface FoundationRegistrationProps {
  onBack: () => void;
  onSuccess: () => void;
}

export const FoundationRegistration = ({ onBack, onSuccess }: FoundationRegistrationProps) => {
      ...
      <div className="bg-white shadow-sm border-b border-red-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Foundation/NGO Registration</h1>
              <p className="text-gray-600 mt-1">Join our network of partner organizations</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-2">
                Please upload: KRS certificate, establishment decision, statute, other relevant documents
              </p>
